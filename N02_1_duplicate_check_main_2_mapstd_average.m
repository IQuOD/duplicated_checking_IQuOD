...
for nian=2008:2008
    ...
    DNA_mapped=mapstd(DNA_series_copy,0,1);
    ...
    filename=['./potential_duplicates_output/',num2str(nian),'/potential_duplicat_mapstd_',num2str(nian),'.txt'];
    if(exist(filename))
        delete(filename)
    end
