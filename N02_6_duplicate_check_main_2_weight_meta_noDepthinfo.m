%%% Using mapminmax normalize each line of data, calculate the weighted average by entropy weight method, and then compare which 'DNA' are closer
...
for nian=1995:1995
    ...
    filename=['./potential_duplicates_output/',num2str(nian),'/potential_duplicate_',num2str(nian),'_weight_meta_noDepthInfo.txt'];
