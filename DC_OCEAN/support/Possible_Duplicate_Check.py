...
### @file  Possible_Duplicate_Check.py
### @brief 
### @version
...
if __name__ == '__main__':
    ...
    DNA_summary_filename = os.path.dirname(os.path.abspath(__file__)) + "/../Input_files/"

    parser = argparse.ArgumentParser(description='Possible Duplicate Check')
    parser.add_argument("-d", "--dna", type=str, default=DNA_summary_filename)
    args = parser.parse_args()
    DNA_summary_filename = args.dna
