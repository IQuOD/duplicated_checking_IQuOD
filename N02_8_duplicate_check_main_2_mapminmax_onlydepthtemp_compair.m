...
for nian=1995:1995
    ...
    DNA_series_temp_depth_1(abs(DNA_series_temp_depth_1)>1e6)=NaN; %%%空缺值missing value
    % figure()
    % plot(DNA_series_temp_depth(:,2),'o')
    
    %对列进行归一化
    DNA_series_temp_depth_2=mapminmax(DNA_series_temp_depth_1',0,1);
    DNA_series_temp_depth=DNA_series_temp_depth_2';
    
    %对列进行标准化
%     DNA_series_temp_depth_2=mapstd(DNA_series_temp_depth_1',0,1);
%     DNA_series_temp_depth=DNA_series_temp_depth_2';
